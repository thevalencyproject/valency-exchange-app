...
class SignUpKYCFaceScreen extends StatelessWidget {
  SignUpKYCFaceScreen({super.key});
        ...
        child: Center(
          child: Column(
            children: const[
              ...
              Text('Take a selfie with you and your ID.', 
                style: TextStyle(
                  color: Colors.black, 
                  fontSize: 48,
              ...
              ValencyKYCCamera(   // Displays the KYC camera - set to take front license photo
                photoType: 2,     // 0 = Front Licence, 1 = Back License, 2 = Face Photo
              ),
